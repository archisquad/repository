...
1. Create an instance of the Observatory by calling observerFactory(). You can
...
The decision to employ the factory pattern for creating `Observatory` instances
